# -*- coding: utf-8 -*-
"""Unet + MobileNetv2.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1fgzBshDzJsjj33TnHd8latSPdlZwWh78
"""
...
plt.plot(um.history['dice_coef'], label='train_dice_coef')
plt.plot(um.history['val_dice_coef'], label='test_dice_coef')
plt.legend()
plt.show()

plt.plot(um.history['loss'], label='train_loss')
plt.plot(um.history['val_loss'], label='test_loss')
plt.legend()
plt.show()
